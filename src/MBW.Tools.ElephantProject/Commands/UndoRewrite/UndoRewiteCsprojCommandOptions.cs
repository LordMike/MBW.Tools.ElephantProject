...
{
    [TargetCommand(typeof(UndoRewiteCsprojCommand))]
    class UndoRewiteCsprojCommandOptions : CommandOptionsBase
    {
        ...
        {
            Command cmd = new Command("undo-rewrite", "Undo rewrite of project files, replacing package references");
